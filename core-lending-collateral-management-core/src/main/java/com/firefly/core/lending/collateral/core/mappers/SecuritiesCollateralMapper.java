...
public interface SecuritiesCollateralMapper {
    SecuritiesCollateralDTO toDTO(SecuritiesCollateral entity);
    SecuritiesCollateral toEntity(SecuritiesCollateralDTO dto);
}
