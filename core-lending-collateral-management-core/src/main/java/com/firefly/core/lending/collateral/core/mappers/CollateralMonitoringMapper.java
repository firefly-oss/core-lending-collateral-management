...
public interface CollateralMonitoringMapper {
    CollateralMonitoringDTO toDTO(CollateralMonitoring entity);
    CollateralMonitoring toEntity(CollateralMonitoringDTO dto);
}
